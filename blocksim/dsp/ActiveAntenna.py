...
__all__ = ["ActiveAntenna"]


class ActiveAntenna(AComputer):
    ...
    **tx_sig** is the RX signal
    ...
    Args:
        ...
        th_profile
            Function that associated to an off-axis angle the distance between the antenna and the receiver
        win
            The window to apply to the antenna
