...
class ABaxe(metaclass=ABCMeta):
    ...
    @abstractmethod
    def createMplAxe(self, mfig: Figure, mgs: SubplotSpec) -> Union[Axes, B3DPlotter]:
        pass

    def render(self, maxe: Axes) -> Axes:
